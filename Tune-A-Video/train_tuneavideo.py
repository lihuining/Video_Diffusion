...
import sys
sys.path.insert(0,'/mnt/workspace/workgroup_share/lhn/Tune-A-Video')
    ...
    for epoch in range(first_epoch, num_train_epochs):
        ...
        for step, batch in enumerate(train_dataloader):
            ...
            with accelerator.accumulate(unet):
                ...
                latents = vae.encode(pixel_values).latent_dist.sample() # [bf,c,h,w]
...
if __name__ == "__main__":
    ...
    parser.add_argument("--config", type=str, default="/mnt/workspace/workgroup_share/lhn/Tune-A-Video/configs/man-skiing.yaml")
    args = parser.parse_args()

    main(**OmegaConf.load(args.config))
    '''
    15:30 开始训练,16:19训练结束

...
class Model:
    ...
    def process_controlnet_canny(self,
        ...
        if self.model_type != ModelType.ControlNetCanny:
            controlnet = ControlNetModel.from_pretrained(
                "/mnt/workspace/workgroup_share/lhn/utils/lllyasviel/sd-controlnet-canny")
            self.set_model(ModelType.ControlNetCanny,
                           model_id="/mnt/workspace/workgroup_share/lhn/utils/runwayml/stable-diffusion-v1-5", controlnet=controlnet)
    ...
    def process_controlnet_pose(self,
        ...
        if self.model_type != ModelType.ControlNetPose:
            controlnet = ControlNetModel.from_pretrained(
                "/mnt/workspace/workgroup_share/lhn/utils/fusing/stable-diffusion-v1-5-controlnet-openpose")
    ...
    def process_text2video(self,
                           prompt,
                           model_name="/mnt/workspace/workgroup_share/lhn/utils/dreamlike-art/dreamlike-photoreal-2.0",
